...
from langchain.agents import AgentExecutor, create_structured_chat_agent  # استخدام create_structured_chat_agent بدلاً من create_openai_tools_agent
...
class OracleAPEXBaseAgent:
    ...
    def __init__(
        ...
        model: str = "claude-3-7-sonnet-20250219",  # تغيير النموذج الافتراضي إلى Claude
        ...
        # Initialize the language model with Anthropic
...
"""
    ...
    def _create_agent(self) -> AgentExecutor:
        ...
        # Create the agent
        if self.tools:
            # استخدام create_structured_chat_agent بدلاً من create_openai_tools_agent
